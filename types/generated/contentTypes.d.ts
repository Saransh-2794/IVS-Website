...
export interface ApiCenterCenter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    departure_country: Attribute.Relation<
      'api::center.center',
      'oneToOne',
...
export interface ApiDepartureCountryDepartureCountry
  extends Schema.CollectionType {
  collectionName: 'departure_countries';
  info: {
    singularName: 'departure-country';
    pluralName: 'departure-countries';
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::departure-country.departure-country', 'label'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHeaderLinkHeaderLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    items: Attribute.DynamicZone<['elements.nested-links']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNewsAndArticleNewsAndArticle extends Schema.CollectionType {
  ...
  attributes: {
    departure_country: Attribute.Enumeration<
      ['India', 'UAE', 'United States', 'Canada']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    slug: Attribute.UID<'api::news-and-article.news-and-article', 'title'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPassportServicePassportService
  ...
  attributes: {
    ...
    office: Attribute.Enumeration<['EOI', 'CGI']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    tabs: Attribute.DynamicZone<['elements.tab']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPublicHolidaysAndClosurePublicHolidaysAndClosure
  extends Schema.CollectionType {
  collectionName: 'public_holidays_and_closures';
  info: {
    singularName: 'public-holidays-and-closure';
    pluralName: 'public-holidays-and-closures';
    displayName: 'Public Holidays and Closure';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    news_and_articles: Attribute.Relation<
      'api::tag.tag',
      'manyToMany',
      'api::news-and-article.news-and-article'
    >;
...
export interface ApiVisaTypeVisaType extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    slug: Attribute.UID<'api::visa-type.visa-type', 'title'>;
    tabs: Attribute.DynamicZone<['elements.tab']>;
    content: Attribute.Text;
    departure_country: Attribute.Relation<
      'api::visa-type.visa-type',
      'oneToOne',
      'api::departure-country.departure-country'
    >;
    createdAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::public-holidays-and-closure.public-holidays-and-closure': ApiPublicHolidaysAndClosurePublicHolidaysAndClosure;
